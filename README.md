...
OpenCode uses the 2.0.8 client. Scoped overrides keep its Effect peer and schema/protocol dependencies on the workspace Effect catalog. See [AI writing](docs/architecture/ai-writing.md) for provider lifecycle and isolation details.
