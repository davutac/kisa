...
export const HOTKEY_COMMANDS = {
  ...
  "scheduled.cancel": {
    bindings: ["Mod+S"],
    input: "ignore",
    label: "Cancel schedule and move to Stash",
    repeat: "once",
    scope: "scheduled",
  },
  ...
  "scheduled.previous": {
    bindings: ["Shift+Tab", "ArrowUp", "K"],
    input: "ignore",
    label: "Previous scheduled email",
    repeat: "allow",
    scope: "scheduled",
  },
